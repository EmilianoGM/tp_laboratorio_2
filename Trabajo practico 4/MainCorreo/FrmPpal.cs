...
{
    /*
     AVISO: El cuadro con el mensaje de error en caso de fallo en la coneccion 
     de la base de datos puede tardar en aparecer; no supe como resolver esa situacion.
    */
